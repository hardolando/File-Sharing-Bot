...
async def channel_post(client: Client, message: Message):
    reply_text = await message.reply_text("Sabar sayang, gua cariin dulu filenya!", quote = True)
    try:
        ...
        print(e)
        await reply_text.edit_text("Salah bos..!!")
        return
    ...
    await reply_text.edit(f"<b>Here is ur link My Lord...!</b>\n\n{link}", reply_markup=reply_markup, disable_web_page_preview = True)
